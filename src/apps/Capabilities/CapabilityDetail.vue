...
export default {
    ...
    setup (props, ctx) {
        const { capabilities } = useContext(ctx)
...
<template lang="pug">
standard-column-layout.CapabilityDetail(
    ...
    template(#insert-body)
        .CapabilityDetail-content(
            v-bind="$vefa.content"
            v-html="content"
        )

//-     template(#append)
//-         aside.CapabilityDetail-crosslinks(
//-             v-bind="$vefa.crosslinks"
//-             v-if="activeContext.crossLinks.length"
//-         )
//-             h3.CapabilityDetail-crosslinks-hed(
//-                 v-bind="$vefa.crosslinkHed"
//-             ) How PCGI does {{ activeContext.hed }}
//-             //- spotlight-card

//-             template(v-for="item in activeContext.crossLinks")
//-                 crosslink-card(
//-                     v-bind="item"
//-                 )
</template>
...
// .CapabilityDetail-crosslinks
//     grid-area: append
//     --columns: 1fr 1fr

// .CapabilityDetail-crosslinks-hed
//     grid-column: span 2
